...
const BLOG = {
  ...
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '迪升,disheng,迪升博客,迪升的博客,disheng blog,disheng.org,blog.disheng.org,ai,chatgpt,openai,ai.com,poe,opencat,chatbox,openai translator,Notion, 博客', // 网站关键词 英文逗号隔开
